...
private:
    ...
    bool shouldForward(const DecodedPacket& packet, int16_t rssi, const ProcessingContext& ctx);
    ...
    bool enqueueDelayed(const uint8_t* encodedPacket, uint16_t length, uint32_t delayMs);
