...
//
// HTCC-AB02A Note: ADC is a CubeCell framework constant that maps to the
// user-accessible ADC channel (typically ADC_USER_CHANNEL). The framework
// handles the pin mapping automatically.
