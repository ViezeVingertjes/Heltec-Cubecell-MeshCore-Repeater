...
#define LOG_DEBUG_FMT(fmt, ...)                                                \
  logger.logFormat(LogLevel::DEBUG, fmt, __VA_ARGS__)
#define LOG_INFO_FMT(fmt, ...)                                                 \
  logger.logFormat(LogLevel::INFO, fmt, __VA_ARGS__)
#define LOG_WARN_FMT(fmt, ...)                                                 \
  logger.logFormat(LogLevel::WARN, fmt, __VA_ARGS__)
#define LOG_ERROR_FMT(fmt, ...)                                                \
  logger.logFormat(LogLevel::ERROR, fmt, __VA_ARGS__)
#else
